...
parser.add_argument('-c', '--config', help='The config argument.', default='hyperopt-sinusoidalLong-gru')#test, hyperopt, hyperopt-test, hyperopt-sinusoidal
...
SAVE_DIR = './hyperopt-sinusoidalLong-gru{}/{}/{}/{}'.format(test_str, args.folder, args.dataset, args.config)
