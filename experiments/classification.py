...
parser.add_argument('-c', '--config', help='The config argument.', default='hyperopt-neural-cde')#test, hyperopt, hyperopt-test
...
SAVE_DIR = './models_ncde{}/{}/{}/{}'.format(test_str, args.folder, args.dataset, args.config)
