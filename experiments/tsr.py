...
parser.add_argument('-f', '--folder', help='Folder that holds the data.', default='Other')#TSR, Other
parser.add_argument('-ds', '--dataset', help='The name of the dataset to run.', default='LOB')#BIDMC32HR, LOB
parser.add_argument('-c', '--config', help='The config argument.', default='hyperopt-lob')#hyperopt-lob
...
SAVE_DIR = './models_tmp{}/{}/{}/{}'.format(test_str, args.folder, args.dataset, args.config)
...
if __name__ == '__main__':
    ...
    #configuration['data__batch_size'] = [20000]
    # Gridsearch it
